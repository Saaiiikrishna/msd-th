...
export function AdventuresGrid({ searchParams }: AdventuresGridProps) {
  ...
  if (!adventures || !adventures.adventures || adventures.adventures.length === 0) {
    return (
      <NeumorphicCard className="text-center py-12">
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h2 className="text-2xl font-semibold text-neutral-800">
            {adventures?.adventures?.length || 0} Adventures Found
          </h2>
      ...
      {adventures && adventures.adventures && adventures.adventures.length > 12 && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-sm text-neutral-600 mt-2">
            Showing {adventures.adventures.length} adventures
          </p>
        </motion.div>
      )}
    </div>
